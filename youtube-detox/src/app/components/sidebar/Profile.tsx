...
const Profile = () => {
  ...
  return (
    <div className='fixed bg-black backdrop-blur-sm bg-opacity-25 w-full h-full top-0 left-0 flex justify-center items-center'>
      <div className={`w-[200px] h-fit ${theme == "dark" ? "bg-black text-slate-200 shadow-slate-300" : "bg-white border-2 text-black shadow-black"} rounded-lg p-6 flex flex-col justify-center items-center absolute relative shadow-sm `}>
