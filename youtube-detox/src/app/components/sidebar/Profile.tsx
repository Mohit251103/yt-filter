...
const Profile = () => {
  ...
  return (
    <div className={`w-[200px] h-fit ${theme=="dark"?"bg-black text-slate-200": "bg-white border-2 text-black"} rounded-lg p-6 flex flex-col justify-center items-center absolute right-1`}>
